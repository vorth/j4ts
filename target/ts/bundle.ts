...
namespace java.util {
    ...
    export class Observable {
        ...
        private obs : java.util.Vector<java.util.Observer>;

        /**
         * Construct an Observable with zero Observers.
         */
        public constructor() {
            this.obs = new java.util.Vector<any>();
        }
         ...
         */
        public addObserver(o : java.util.Observer) {
         ...
         */
        public deleteObserver(o : java.util.Observer) {
         ...
         */
        public notifyObservers(arg : any = null) {
            var arrLocal : any[];
            if(!this.changed) return;
            arrLocal = this.obs.toArray();
            this.clearChanged();
            for(var i : number = arrLocal.length - 1; i >= 0; i--) (<java.util.Observer>arrLocal[i]).update(this, arg)
        }
...
namespace java.io {
     ...
     */
    export abstract class Reader implements java.io.Closeable {
        lock : any;
        ...
        public read$() : number {
            var cb : string[] = new Array(1);
            if(this.read(cb, 0, 1) === -1) return -1; else return (cb[0]).charCodeAt(0);
        }
 ...
 return 0;             } else if(((cbuf != null && cbuf instanceof Array) || cbuf === null) && off === undefined && len === undefined) {
         ...
         */
        private static maxSkipBufferSize : number = 8192;

        /**
         * Skip buffer, null until allocated
         */
        private skipBuffer : string[] = null;

        public skip(n : number) : number {
            if(n < 0) throw new java.lang.IllegalArgumentException("skip value is negative");
            var nn : number = (<number>Math.min(n, Reader.maxSkipBufferSize)|0);
            if((this.skipBuffer == null) || (this.skipBuffer.length < nn)) this.skipBuffer = new Array(nn);
            var r : number = n;
            while((r > 0)){
                var nc : number = this.read(this.skipBuffer, 0, (<number>Math.min(r, nn)|0));
                if(nc === -1) break;
                r -= nc;
            };
            return n - r;
...
namespace java.io {
    ...
    export class BufferedReader extends java.io.Reader {
        ...
        private static INVALIDATED : number = -2;

        private static UNMARKED : number = -1;
        ...
        private static defaultExpectedLineLength : number = 80;
        ...
        public constructor(__in? : any, sz? : any) {
            if(((__in != null && __in instanceof java.io.Reader) || __in === null) && ((typeof sz === 'number') || sz === null)) {
                ...
                (() => {
                    ...
                    this.skipLF = false;
                    this.markedSkipLF = false;
                    if(sz <= 0) throw new java.lang.IllegalArgumentException("Buffer size <= 0");
                    this.in = __in;
                ...
                {
                    var sz : any = BufferedReader.defaultCharBufferSize;
                    super(__in);
                    Object.defineProperty(this, '__interfaces', { configurable: true, value: ["java.io.Closeable","java.lang.AutoCloseable"] });
                    this.nChars = 0;
                    this.nextChar = 0;
        ...
        private fill() {
            ...
            if(this.markedChar <= BufferedReader.UNMARKED) {
                ...
                var delta : number = this.nextChar - this.markedChar;
                if(delta >= this.readAheadLimit) {
                    ...
                    if(this.readAheadLimit <= this.cb.length) {
                        ...
                        var ncb : string[] = new Array(this.readAheadLimit);
        ...
        private read1(cbuf : string[], off : number, len : number) : number {
            if(this.nextChar >= this.nChars) {
            ...
            var n : number = Math.min(len, this.nChars - this.nextChar);
                ...
                return <any>(() => {
                    {
                        ...
                        var n : number = this.read1(cbuf, off, len);
                        if(n <= 0) return n;
                        while(((n < len) && this.in.ready())){
                            var n1 : number = this.read1(cbuf, off + n, len - n);
                            if(n1 <= 0) break;
                            n += n1;
                        };
                        return n;
        ...
        public readLine(ignoreLF : boolean = false) : string {
            var s : java.lang.StringBuffer = null;
            var startChar : number;
            {
                this.ensureOpen();
                var omitLF : boolean = ignoreLF || this.skipLF;
                for(; ; ) {
                    if(this.nextChar >= this.nChars) this.fill();
                    if(this.nextChar >= this.nChars) {
                    ...
                    var c : string = String.fromCharCode(0);
                    var i : number;
                    ...
                    if(s == null) s = new java.lang.StringBuffer(BufferedReader.defaultExpectedLineLength);
                    s.append(this.cb, startChar, i - startChar);
                }
            };
        }
        ...
        public skip(n : number) : number {
            ...
            }
            {
                ...
                while((r > 0)){
                    ...
                    var d : number = this.nChars - this.nextChar;
                    if(r <= d) {
                        this.nextChar += r;
                        r = 0;
                        break;
        ...
        public reset() {
            {
                this.ensureOpen();
                if(this.markedChar < 0) throw new java.io.IOException((this.markedChar === BufferedReader.INVALIDATED)?"Mark invalid":"Stream not marked");
...
namespace javaemul.internal {
    ...
    export class CharacterHelper implements java.lang.Comparable<CharacterHelper>, java.io.Serializable {
        ...
        public static isDigit(c : string) : boolean {
            var result : RegExpMatchArray = (/* valueOf */new String(c).toString()).match(CharacterHelper.digitRegex());
...
namespace java.io {
    ...
    export abstract class FileSystem {
        ...
        static __static_initialize() { if(!FileSystem.__static_initialized) { FileSystem.__static_initialized = true; FileSystem.__static_initializer_0(); } }
         ...
         */
        public abstract getPathSeparator() : string;

        public normalize(pathname? : any, len? : any, off? : any) : any {
            if(((typeof pathname === 'string') || pathname === null) && len === undefined && off === undefined) {
                return <any>this.normalize$java_lang_String(pathname);
            } else throw new Error('invalid overload');
        }
         ...
         */
        public normalize$java_lang_String(path : string) : string { throw new Error('cannot invoke abstract overloaded method... check your argument(s) type(s)'); }

        /**
         * Compute the length of this pathname string's prefix.  The pathname
         * string must be in normal form.
         */
        public abstract prefixLength(path : string) : number;
         ...
         */
        public resolve(parent? : any, child? : any) : any {
            if(((typeof parent === 'string') || parent === null) && ((typeof child === 'string') || child === null)) {
 return null;             } else if(((parent != null && parent instanceof java.io.File) || parent === null) && child === undefined) {
                return <any>this.resolve$java_io_File(parent);
            } else throw new Error('invalid overload');
        }
         ...
         */
        public abstract fromURIPath(path : string) : string;

        /**
         * Tell whether or not the given abstract pathname is absolute.
         */
        public abstract isAbsolute(f : java.io.File) : boolean;

        /**
         * Resolve the given abstract pathname into absolute form.  Invoked by the
         * getAbsolutePath and getCanonicalPath methods in the File class.
         */
        public resolve$java_io_File(f : java.io.File) : string { throw new Error('cannot invoke abstract overloaded method... check your argument(s) type(s)'); }

        public abstract canonicalize(path : string) : string;

        public static BA_EXISTS : number = 1;

        public static BA_REGULAR : number = 2;

        public static BA_DIRECTORY : number = 4;

        public static BA_HIDDEN : number = 8;
         ...
         */
        public abstract getBooleanAttributes(f : java.io.File) : number;

        public static ACCESS_READ : number = 4;

        public static ACCESS_WRITE : number = 2;

        public static ACCESS_EXECUTE : number = 1;
         ...
         */
        public abstract checkAccess(f : java.io.File, access : number) : boolean;
         ...
         */
        public abstract setPermission(f : java.io.File, access : number, enable : boolean, owneronly : boolean) : boolean;
         ...
         */
        public abstract getLastModifiedTime(f : java.io.File) : number;
         ...
         * I/O error occurs.
         */
        public abstract getLength(f : java.io.File) : number;
         ...
         */
        public abstract createFileExclusively(pathname : string) : boolean;

        /**
         * Delete the file or directory denoted by the given abstract pathname,
         * returning <code>true</code> if and only if the operation succeeds.
         */
        public abstract delete(f : java.io.File) : boolean;
         ...
         */
        public abstract list(f : java.io.File) : string[];

        /**
         * Create a new directory denoted by the given abstract pathname,
         * returning <code>true</code> if and only if the operation succeeds.
         */
        public abstract createDirectory(f : java.io.File) : boolean;
         ...
         */
        public abstract rename(f1 : java.io.File, f2 : java.io.File) : boolean;
         ...
         * operation succeeds.
         */
        public abstract setLastModifiedTime(f : java.io.File, time : number) : boolean;
         ...
         * succeeds.
         */
        public abstract setReadOnly(f : java.io.File) : boolean;
        ...
        public static SPACE_TOTAL : number = 0;

        public static SPACE_FREE : number = 1;

        public static SPACE_USABLE : number = 2;

        public abstract getSpace(f : java.io.File, t : number) : number;

        /**
         * Compare two abstract pathnames lexicographically.
         */
        public abstract compare(f1 : java.io.File, f2 : java.io.File) : number;

        /**
         * Compute the hash code of an abstract pathname.
         */
        public abstract hashCode(f : java.io.File) : number;

        static useCanonCaches : boolean = true;

        static useCanonPrefixCache : boolean = true;

        private static getBooleanProperty(prop : string, defaultVal : boolean) : boolean {
            var val : string = java.lang.System.getProperty(prop);
            if(val == null) return defaultVal;
            if(/* equalsIgnoreCase */((o1, o2) => o1.toUpperCase() === (o2===null?o2:o2.toUpperCase()))(val, "true")) {
                return true;
            } else {
                return false;
            }
...
namespace java.awt.event {
    export class ActionEvent {
        ...
        public constructor(source : any, actionCommand : string) {
            this.source = source;
...
namespace java.util {
    ...
    export interface Observer {
         ...
         * method.
         */
        update(o : java.util.Observable, arg : any);
    }
}
"Generated from Java with JSweet 1.2.0-SNAPSHOT - http://www.jsweet.org";
namespace java.util {
...
"Generated from Java with JSweet 1.2.0-SNAPSHOT - http://www.jsweet.org";
namespace java.awt {
    export interface Layout extends java.awt.HTMLComponent {
        add(component : java.awt.HTMLComponent);
    }
}
"Generated from Java with JSweet 1.2.0-SNAPSHOT - http://www.jsweet.org";
namespace java.io {
...
namespace java.io {
    ...
    export class FileNotFoundException extends java.io.IOException {
        private static serialVersionUID : number = -897856973823710492;
...
namespace test {
    export class Test {
        ...
        public static testIO() {
            ...
            var dir : java.io.File = new java.io.File("/a/b/c");
            Test.assertFalse(dir.exists());
            dir.mkdirs();
            Test.assertTrue(dir.exists());
            var f : java.io.File = new java.io.File(dir, "test.txt");
            Test.assertFalse(f.exists());
            f.createNewFile();
            Test.assertTrue(f.exists());
            var fw : java.io.FileWriter = new java.io.FileWriter(f);
            fw.append("abc");
            fw.close();
            var reader : java.io.BufferedReader = new java.io.BufferedReader(new java.io.FileReader(f));
...
namespace java.util {
    ...
    export class InternalHashCodeMap<K, V> implements java.lang.Iterable<Map.Entry<K, V>> {
        ...
        private findEntryInChain(key : any, chain : Map.Entry<K, V>[]) : java.util.Map.Entry<K, V> {
            for(var index125=0; index125 < chain.length; index125++) {
                var entry = chain[index125];
                {
                    if(this.host._equals(key, entry.getKey())) {
                        return entry;
                    }
...
namespace java.io {
    ...
    export class FileOutputStream extends java.io.OutputStream {
        ...
        private entry : java.io.LocalStorageFileSystem.Entry;

        private content : number[];

        public constructor(name? : any, append? : any) {
            if(((typeof name === 'string') || name === null) && ((typeof append === 'boolean') || append === null)) {
                {
                    var file : any = name != null?new java.io.File(name):null;
                    super();
                    Object.defineProperty(this, '__interfaces', { configurable: true, value: ["java.io.Closeable","java.lang.AutoCloseable","java.io.Flushable"] });
                    this.append = false;
                    (() => {
                        ...
                        this.file = file;
                        this.append = append;
                        this.entry = java.io.File.fs_$LI$().getEntry(file.getAbsolutePath());
                        this.content = append?/* getBytes */(this.entry.data).split('').map(s => s.charCodeAt(0)):new Array(0);
                    })();
                }
                (() => {
                })();
        ...
        private write$int$boolean(b : number, append : boolean) {
            (this.content).push((<number>b|0));
        }
        ...
        private writeBytes(b : number[], off : number, len : number, append : boolean) {
            for(var i : number = off; i < off + len; i++) {
                (this.content).push(b[i]);
            }
        }

        public write$byte_A(b : number[]) {
        ...
        public write(b? : any, off? : any, len? : any) : any {
            if(((b != null && b instanceof Array) || b === null) && ((typeof off === 'number') || off === null) && ((typeof len === 'number') || len === null)) {
                ...
                return <any>this.write$int$boolean(b, off);
            } else if(((b != null && b instanceof Array) || b === null) && off === undefined && len === undefined) {
                return <any>this.write$byte_A(b);
        ...
        public flush() {
            this.entry.data = btoa(((this.content).map<any>((b, __, ___) => {
...
"Generated from Java with JSweet 1.2.0-SNAPSHOT - http://www.jsweet.org";
namespace java.awt {
    export class TextField extends java.awt.Component implements java.awt.HTMLComponent {
        ...
        private initActionListener() {
            if(this.actionListener != null) {
                this.input.onclick = (e) => {
                    this.actionListener.actionPerformed(new java.awt.event.ActionEvent(this, null));
                    return e;
                };
            }
        }
        ...
        public addActionListener(actionListener : java.awt.event.ActionListener) {
...
"Generated from Java with JSweet 1.2.0-SNAPSHOT - http://www.jsweet.org";
namespace java.awt {
    export class Button extends java.awt.Component implements java.awt.HTMLComponent {
        ...
        private initActionListener() {
            if(this.actionListener != null) {
                this.button.onclick = (e) => {
                    console.log("button clicked: " + this.actionCommand);
                    this.actionListener.actionPerformed(new java.awt.event.ActionEvent(this, this.actionCommand));
                    return e;
                };
            }
        }
        ...
        public setBackground(background : java.awt.Color) {
...
namespace java.io {
    ...
    export class InputStreamReader extends java.io.Reader {
        ...
        public constructor(__in? : any, charsetName? : any) {
            if(((__in != null && __in instanceof java.io.InputStream) || __in === null) && ((typeof charsetName === 'string') || charsetName === null)) {
                ...
                var cs : any = charsetName;
                super(__in);
                Object.defineProperty(this, '__interfaces', { configurable: true, value: ["java.io.Closeable","java.lang.AutoCloseable"] });
                (() => {
                    this.in = __in;
                    if(cs == null) throw new java.lang.NullPointerException("charset");
                })();
...
namespace java.awt {
    export abstract class Graphics {
        public abstract drawString(s : string, x : number, y : number);
    }
}
"Generated from Java with JSweet 1.2.0-SNAPSHOT - http://www.jsweet.org";
namespace java.awt {
    export class WebGraphics2D extends java.awt.Graphics {
...
"Generated from Java with JSweet 1.2.0-SNAPSHOT - http://www.jsweet.org";
namespace java.io {
    export class LocalStorageFileSystem extends java.io.FileSystem {
        roots : java.io.File[];
        ...
        public normalize(pathname? : any, len? : any, off? : any) : any {
            if(((typeof pathname === 'string') || pathname === null) && ((typeof len === 'number') || len === null) && ((typeof off === 'number') || off === null)) {
                return <any>(() => {
                    ...
                    if(n === 0) return "/";
                    var sb : java.lang.StringBuffer = new java.lang.StringBuffer(pathname.length);
                    if(off > 0) sb.append(pathname.substring(0, off));
                    var prevChar : string = String.fromCharCode(0);
                    for(var i : number = off; i < n; i++) {
                        var c : string = pathname.charAt(i);
        ...
        public normalize$java_lang_String(pathname : string) : string {
            var n : number = pathname.length;
            var prevChar : string = String.fromCharCode(0);
            for(var i : number = 0; i < n; i++) {
                var c : string = pathname.charAt(i);
                if((prevChar === '/') && (c === '/')) return this.normalize(pathname, n, i - 1);
                prevChar = c;
            }
            if(prevChar === '/') return this.normalize(pathname, n, n - 1);
            return pathname;
        }

        public prefixLength(pathname : string) : number {
        ...
        public fromURIPath(path : string) : string {
            var p : string = path;
            if(/* endsWith */((str, searchString) => { var pos = str.length - searchString.length; var lastIndex = str.indexOf(searchString, pos); return lastIndex !== -1 && lastIndex === pos; })(p, "/") && (p.length > 1)) {
                p = p.substring(0, p.length - 1);
            }
            return p;
        }

        public isAbsolute(f : java.io.File) : boolean {
            return (f.getPrefixLength() !== 0);
        }

        public resolve$java_io_File(f : java.io.File) : string {
            if(this.isAbsolute(f)) return f.getPath();
            return this.resolve(java.lang.System.getProperty("user.dir"), f.getPath());
        }

        public canonicalize(path : string) : string {
            return this.normalize(path);
        }

        public getBooleanAttributes(f : java.io.File) : number {
            var e : LocalStorageFileSystem.Entry = this.getEntry(f.getAbsolutePath());
            return e == null?0:e.attributes;
        }

        public checkAccess(f : java.io.File, access : number) : boolean {
            return (this.getEntry(f.getAbsolutePath()).access & access) !== 0;
        }

        public setPermission(f : java.io.File, access : number, enable : boolean, owneronly : boolean) : boolean {
            return false;
        }

        public getLastModifiedTime(f : java.io.File) : number {
            return this.getEntry(f.getAbsolutePath()).lastModifiedTime;
        }

        public getLength(f : java.io.File) : number {
        ...
        public createFileExclusively(pathname : string) : boolean {
            var f : java.io.File = new java.io.File(pathname);
            pathname = f.getAbsolutePath();
            if(this.hasEntry(pathname)) {
                return false;
            }
            var parent : java.io.File = f.getParentFile();
            if(parent != null) {
                var parentPath : string = parent.getAbsolutePath();
                var directoryEntry : LocalStorageFileSystem.DirectoryEntry = this.getDirectoryEntry(parentPath);
                if(directoryEntry == null) {
                    throw new java.io.IOException("directory does not exist: " + parentPath);
                }
                var entries : Array<string> = directoryEntry.entries;
                entries.push(f.getName());
                this.putEntry(parentPath, directoryEntry);
            }
            this.putEntry(pathname, <LocalStorageFileSystem.Entry>Object.defineProperty({
        ...
        getEntry(pathname : string) : LocalStorageFileSystem.Entry {
            return <LocalStorageFileSystem.Entry>JSON.parse(<string>localStorage.getItem(this.getKey(pathname)));
        }

        getDirectoryEntry(pathname : string) : LocalStorageFileSystem.DirectoryEntry {
            return <LocalStorageFileSystem.DirectoryEntry>JSON.parse(<string>localStorage.getItem(this.getKey(pathname)));
        }

        putEntry(pathname : string, entry : LocalStorageFileSystem.Entry) {
            localStorage.setItem(this.getKey(pathname), JSON.stringify(entry));
        }

        getChildEntries(pathname : string) : Array<string> {
            var directoryEntry : LocalStorageFileSystem.DirectoryEntry = this.getDirectoryEntry(pathname);
            if(directoryEntry != null) {
        ...
        removeEntry(pathname : string) {
            {
                var array127 = this.getChildEntries(pathname);
                for(var index126=0; index126 < array127.length; index126++) {
                    var e = array127[index126];
                    {
        ...
        public delete(f : java.io.File) : boolean {
            if(this.hasEntry(f.getAbsolutePath())) {
                this.removeEntry(f.getAbsolutePath());
                var parentPath : string = f.getParentFile().getAbsolutePath();
                var directoryEntry : LocalStorageFileSystem.DirectoryEntry = this.getDirectoryEntry(parentPath);
                var entries : Array<string> = directoryEntry.entries;
        ...
        public list(f : java.io.File) : string[] {
            return this.getChildEntries(f.getAbsolutePath());
        }

        public createDirectory(f : java.io.File) : boolean {
            if(this.hasEntry(f.getAbsolutePath())) {
                return false;
            }
            var parent : java.io.File = f.getParentFile();
            ...
            this.putEntry(f.getAbsolutePath(), <LocalStorageFileSystem.DirectoryEntry>Object.defineProperty({
        ...
        public rename(f1 : java.io.File, f2 : java.io.File) : boolean {
            var e1 : LocalStorageFileSystem.Entry = this.getEntry(f1.getAbsolutePath());
            var e2 : LocalStorageFileSystem.Entry = this.getEntry(f2.getAbsolutePath());
            if(e1 == null || e2 != null) {
                return false;
            }
            this.delete(f1);
        ...
        public setLastModifiedTime(f : java.io.File, time : number) : boolean {
            var e : LocalStorageFileSystem.Entry = this.getEntry(f.getAbsolutePath());
            if(e != null) {
        ...
        public setReadOnly(f : java.io.File) : boolean {
        ...
        public getSpace(f : java.io.File, t : number) : number {
            return 0;
        }

        public compare(f1 : java.io.File, f2 : java.io.File) : number {
            return /* compareTo */f1.getAbsolutePath().localeCompare(f2.getAbsolutePath());
        }

        public hashCode(f : java.io.File) : number {
            return (<any>f.getAbsolutePath().toString());
        }
    ...
    export namespace LocalStorageFileSystem {
        ...
        export interface DirectoryEntry extends LocalStorageFileSystem.Entry {
            entries : string[];
        }
    }
...
"Generated from Java with JSweet 1.2.0-SNAPSHOT - http://www.jsweet.org";
namespace java.awt {
    export class GridLayout implements java.awt.Layout {
        ...
        public add(component : java.awt.HTMLComponent) {
            if(this.table == null) {
                this.init();
            }
            var pos : number = 0;
            for(var j : number = 0; j < this.rows; j++) {
                var row : HTMLTableRowElement = <HTMLTableRowElement>this.table.childNodes[j];
                for(var i : number = 0; i < this.cols; i++) {
                    var col : HTMLTableColElement = <HTMLTableColElement>row.childNodes[i];
        ...
        public init() {
            ...
            for(var j : number = 0; j < this.rows; j++) {
                ...
                for(var i : number = 0; i < this.cols; i++) {
                    var col : HTMLTableDataCellElement = document.createElement("td");
                    row.appendChild(col);
                    col.style.width = "" + (((<number>100|0) / this.cols|0)) + "%";
                }
            }
        }
    }
...
namespace java.io {
     ...
     * JSweet implementation.
     */
    export abstract class Writer implements java.lang.Appendable, java.io.Closeable, java.io.Flushable {
        private writeBuffer : string[];

        private static WRITE_BUFFER_SIZE : number = 1024;
        ...
        public append$java_lang_CharSequence(csq : string) : Writer {
            if(csq == null) this.write("null"); else this.write(csq.toString());
            return this;
        }
        ...
        public append(csq? : any, start? : any, end? : any) : any {
            if(((csq != null && (csq["__interfaces"] != null && csq["__interfaces"].indexOf("java.lang.CharSequence") >= 0 || typeof csq === "string")) || csq === null) && ((typeof start === 'number') || start === null) && ((typeof end === 'number') || end === null)) {
                return <any>(() => {
                    var cs : string = (csq == null?"null":csq);
                    this.write(/* subSequence */cs.substring(start, end).toString());
                    return this;
                })();
...
namespace java.io {
    ...
    export class OutputStreamWriter extends java.io.Writer {
        private out : java.io.OutputStream;
        ...
        public constructor(out? : any, charsetName? : any) {
            if(((out != null && out instanceof java.io.OutputStream) || out === null) && ((typeof charsetName === 'string') || charsetName === null)) {
                ...
                Object.defineProperty(this, '__interfaces', { configurable: true, value: ["java.lang.Appendable","java.io.Closeable","java.lang.AutoCloseable","java.io.Flushable"] });
                (() => {
                    if(charsetName == null) throw new java.lang.NullPointerException("charsetName");
                    this.out = out;
                })();
        ...
        public write$java_lang_String$int$int(str : string, off : number, len : number) {
            this.out.write(/* getBytes */(str).split('').map(s => s.charCodeAt(0)), off, len);
        }
...
namespace java.io {
    ...
    export class FileWriter extends java.io.OutputStreamWriter {
        public constructor(fileName? : any, append? : any) {
...
namespace java.util {
    ...
    export class Objects {
        ...
        public static requireNonNull<T>(obj? : any, message? : any) : any {
            ...
            } else if(((obj != null) || obj === null) && ((typeof message === 'function' && (<any>message).length == 0) || message === null)) {
    ...
    export class Logger {
        ...
        private actuallyLog$java_util_logging_LogRecord(record : java.util.logging.LogRecord) {
            if(this.isLoggable(record.getLevel())) {
                ...
                while((logger != null)){
                    {
                        var array131 = logger.getHandlers();
                        for(var index130=0; index130 < array131.length; index130++) {
                            var handler = array131[index130];
                            {
                                handler.publish(record);
                            }
                        }
...
namespace java.io {
     ...
     */
    export class File implements java.io.Serializable, java.lang.Comparable<File> {
        /**
         * The FileSystem object representing the platform's local file system.
         */
        static fs : java.io.LocalStorageFileSystem; public static fs_$LI$() : java.io.LocalStorageFileSystem { if(File.fs == null) File.fs = new java.io.LocalStorageFileSystem(); return File.fs; };

        private path : string;

        private status : File.PathStatus = null;
        ...
        public static separatorChar : string; public static separatorChar_$LI$() : string { if(File.separatorChar == null) File.separatorChar = File.fs_$LI$().getSeparator(); return File.separatorChar; };

        public static separator : string; public static separator_$LI$() : string { if(File.separator == null) File.separator = "" + File.separatorChar_$LI$(); return File.separator; };

        public static pathSeparatorChar : string; public static pathSeparatorChar_$LI$() : string { if(File.pathSeparatorChar == null) File.pathSeparatorChar = File.fs_$LI$().getPathSeparator(); return File.pathSeparatorChar; };

        public static pathSeparator : string; public static pathSeparator_$LI$() : string { if(File.pathSeparator == null) File.pathSeparator = "" + File.pathSeparatorChar_$LI$(); return File.pathSeparator; };

        public constructor(parent? : any, child? : any, direct? : any) {
            if(((parent != null && parent instanceof java.io.File) || parent === null) && ((typeof child === 'string') || child === null) && ((typeof direct === 'boolean') || direct === null)) {
                ...
                this.prefixLength = 0;
                (() => {
                    this.path = File.fs_$LI$().resolve(parent.path, child);
                ...
                (() => {
                    ...
                    if(parent != null) {
                        if((parent === "")) {
                            this.path = File.fs_$LI$().resolve(File.fs_$LI$().getDefaultParent(), File.fs_$LI$().normalize(child));
                        } else {
                            this.path = File.fs_$LI$().resolve(File.fs_$LI$().normalize(parent), File.fs_$LI$().normalize(child));
                        }
                    } else {
                        this.path = File.fs_$LI$().normalize(child);
                    }
                    this.prefixLength = File.fs_$LI$().prefixLength(this.path);
                })();
                ...
                (() => {
                    ...
                    if(parent != null) {
                        if((parent.path === "")) {
                            ...
                            this.path = File.fs_$LI$().resolve(parent.path, File.fs_$LI$().normalize(child));
                        }
                    } else {
                        this.path = File.fs_$LI$().normalize(child);
                    }
                ...
                var pathname : any = parent;
                var prefixLength : any = child;
                Object.defineProperty(this, '__interfaces', { configurable: true, value: ["java.lang.Comparable","java.io.Serializable"] });
                this.prefixLength = 0;
                (() => {
                    this.path = pathname;
                ...
                (() => {
                    ...
                    this.path = File.fs_$LI$().normalize(pathname);
                    this.prefixLength = File.fs_$LI$().prefixLength(this.path);
                })();
            } else throw new Error('invalid overload');
        }
        ...
        public getName() : string {
            var index : number = this.path.lastIndexOf(File.separatorChar_$LI$());
        ...
        public getAbsoluteFile() : File {
            var absPath : string = this.getAbsolutePath();
        ...
        public getCanonicalFile() : File {
            var canonPath : string = this.getCanonicalPath();
            return new File(canonPath, File.fs_$LI$().prefixLength(canonPath));
        }

        static slashify(path : string, isDirectory : boolean) : string {
            var p : string = path;
            if(File.separatorChar_$LI$() !== '/') p = p.replace(File.separatorChar_$LI$(), '/');
            if(!/* startsWith */((str, searchString, position = 0) => str.substr(position, searchString.length) === searchString)(p, "/")) p = "/" + p;
            if(!/* endsWith */((str, searchString) => { var pos = str.length - searchString.length; var lastIndex = str.indexOf(searchString, pos); return lastIndex !== -1 && lastIndex === pos; })(p, "/") && isDirectory) p = p + "/";
            return p;
        }
        ...
        public list(filter? : any) : any {
            if(((typeof filter === 'function' && (<any>filter).length == 2) || filter === null)) {
                return <any>(() => {
                    var names : string[] = this.list();
                    if((names == null) || (filter == null)) {
                        return names;
                    }
                    var v : java.util.List<string> = new java.util.ArrayList<any>();
        ...
        public listFiles$() : File[] {
            var ss : string[] = this.list();
            if(ss == null) return null;
            var n : number = ss.length;
            var fs : File[] = new Array(n);
            for(var i : number = 0; i < n; i++) {
        ...
        public listFiles(filter? : any) : any {
            if(((typeof filter === 'function' && (<any>filter).length == 2) || filter === null)) {
                return <any>(() => {
                    var ss : string[] = this.list();
                    if(ss == null) return null;
                    var files : java.util.ArrayList<File> = new java.util.ArrayList<any>();
                    for(var index132=0; index132 < ss.length; index132++) {
                        var s = ss[index132];
                        if((filter == null) || filter(this, s)) files.add(new File(this, s, true));
                    }
                    return files.toArray(new Array(files.size()));
                })();
            } else if(((typeof filter === 'function' && (<any>filter).length == 1) || filter === null)) {
                return <any>this.listFiles$java_io_FileFilter(filter);
            } else if(filter === undefined) {
                return <any>this.listFiles$();
            } else throw new Error('invalid overload');
        }

        public listFiles$java_io_FileFilter(filter : java.io.FileFilter) : File[] {
            var ss : string[] = this.list();
            if(ss == null) return null;
            var files : java.util.ArrayList<File> = new java.util.ArrayList<any>();
            for(var index133=0; index133 < ss.length; index133++) {
                var s = ss[index133];
                {
                    var f : File = new File(this, s, true);
                    if((filter == null) || filter(f)) files.add(f);
                }
            }
            return files.toArray(new Array(files.size()));
        }
        ...
        public mkdirs() : boolean {
            ...
            var canonFile : File = null;
            try {
                canonFile = this.getCanonicalFile();
            } catch(e) {
                return false;
            };
            var parent : File = canonFile.getParentFile();
            return (parent != null && (parent.mkdirs() || parent.exists()) && canonFile.mkdir());
        }

        public renameTo(dest : File) : boolean {
            if(dest == null) {
                throw new java.lang.NullPointerException();
            }
        ...
        public setLastModified(time : number) : boolean {
            if(time < 0) throw new java.lang.IllegalArgumentException("Negative time");
            if(this.isInvalid()) {
                return false;
            }
        ...
        public static createTempFile(prefix : string, suffix : string, directory : File = null) : File {
            if(prefix.length < 3) throw new java.lang.IllegalArgumentException("Prefix string too short");
            if(suffix == null) suffix = ".tmp";
            var tmpdir : File = (directory != null)?directory:File.TempDirectory.location();
            var f : File;
            do {
            ...
            if(!File.fs_$LI$().createFileExclusively(f.getPath())) throw new java.io.IOException("Unable to create temporary file");
            return f;
        }

        public compareTo(pathname? : any) : any {
            if(((pathname != null && pathname instanceof java.io.File) || pathname === null)) {
                return <any>(() => {
                    return File.fs_$LI$().compare(this, pathname);
                })();
            } else throw new Error('invalid overload');
        }
        ...
        private static serialVersionUID : number = 301077366599181567;
    }
    ...
    export namespace File {
        ...
        export class TempDirectory {
            ...
            static tmpdir : java.io.File; public static tmpdir_$LI$() : java.io.File { if(TempDirectory.tmpdir == null) TempDirectory.tmpdir = new java.io.File(java.lang.System.getProperty("java.io.tmpdir")); return TempDirectory.tmpdir; };
            ...
            static generateFile(prefix : string, suffix : string, dir : java.io.File) : java.io.File {
                var n : number = Math.round(<number>Math.random()) * javaemul.internal.LongHelper.MAX_VALUE;
                ...
                var name : string = prefix + /* toString */(''+n) + suffix;
                var f : java.io.File = new java.io.File(dir, name);
...
namespace java.awt {
    export class Color {
        ...
        public toHTML() : string {
            var sb : java.lang.StringBuilder = new java.lang.StringBuilder();
            sb.append("#");
            var s : string = javaemul.internal.IntegerHelper.toHexString(this.r);
            if(s.length === 1) {
                sb.append("0");
            }
            sb.append(s);
...
namespace java.awt.event {
    export interface ActionListener {
        actionPerformed(ae : java.awt.event.ActionEvent);
    }
}
"Generated from Java with JSweet 1.2.0-SNAPSHOT - http://www.jsweet.org";
/**
...
namespace java.applet {
    export class Applet {
        static __static_initialized : boolean = false;
        static __static_initialize() { if(!Applet.__static_initialized) { Applet.__static_initialized = true; Applet.__static_initializer_0(); } }
        ...
        static __static_initializer_0() {
            ...
            window.onload = (e) => {
                ...
                var divList : NodeListOf<Element> = document.getElementsByClassName("applet");
                if(divList.length === 0) {
                    return null;
                }
                var div : HTMLDivElement = <HTMLDivElement>divList[0];
                if(div.getAttribute("data-applet") != null) {
                    ...
                    var names : string[] = div.getAttribute("data-applet").split(".");
                    var constructor : any = window;
                    for(var index134=0; index134 < names.length; index134++) {
                        var name = names[index134];
                        {
                            constructor = constructor[name];
                            console.info("name: " + name + " -> " + constructor);
                        }
                    }
                    var applet : Applet = new (<any>constructor)();
                    applet.container = div;
                    var g : java.awt.Graphics = new java.awt.WebGraphics2D(canvas);
                    applet.init();
                    applet.paint(g);
                }
                return null;
        ...
        public paint(g : java.awt.Graphics) {
            var wg : java.awt.WebGraphics2D = <java.awt.WebGraphics2D>g;
            if(this.backgroundColor != null) {
                wg.getContext().fillStyle = (<any>this.backgroundColor.toHTML());
        ...
        public setBackground(c : java.awt.Color) {
            this.backgroundColor = c;
        }

        public setLayout(layout : java.awt.Layout) {
            this.layout = layout;
        ...
        public addAll(index? : any, c? : any) : any {
            if(((typeof index === 'number') || index === null) && ((c != null && c["__interfaces"] != null && c["__interfaces"].indexOf("java.util.Collection") >= 0) || c === null)) {
                return <any>(() => {
                    javaemul.internal.InternalPreconditions.checkNotNull(c);
                    var changed : boolean = false;
                    for(var index140=c.iterator();index140.hasNext();) {
                        var e = index140.next();
                        {
                            this.add(index++, e);
                            changed = true;
    ...
    export abstract class AbstractSet<E> extends java.util.AbstractCollection<E> implements java.util.Set<E> {
        ...
        public removeAll(c : java.util.Collection<any>) : boolean {
            ...
            if(size < c.size()) {
                ...
                for(var index165=c.iterator();index165.hasNext();) {
                    var o1 = index165.next();
                    {
                        this.remove(o1);
                    }
                }
        ...
        public addAll(index? : any, c? : any) : any {
            if(((typeof index === 'number') || index === null) && ((c != null && c["__interfaces"] != null && c["__interfaces"].indexOf("java.util.Collection") >= 0) || c === null)) {
                return <any>(() => {
                    ...
                    var iter : java.util.ListIterator<E> = this.listIterator(index);
                    for(var index169=c.iterator();index169.hasNext();) {
                        var e = index169.next();
                        {
                            iter.add(e);
                            modified = true;
...
namespace java.util {
    ...
    export abstract class AbstractMap<K, V> implements java.util.Map<K, V> {
        ...
        public containsValue(value : any) : boolean {
            for(var index171=this.entrySet().iterator();index171.hasNext();) {
        ...
        public equals(obj : any) : boolean {
            ...
            for(var index172=otherMap.entrySet().iterator();index172.hasNext();) {
        ...
        public putAll(map : java.util.Map<any, any>) {
            ...
            for(var index173=map.entrySet().iterator();index173.hasNext();) {
                var e = index173.next();
                {
        ...
        public toString$() : string {
            var joiner : java.util.StringJoiner = new java.util.StringJoiner(", ", "{", "}");
            for(var index174=this.entrySet().iterator();index174.hasNext();) {
...
namespace java.util {
    ...
    export abstract class AbstractHashMap<K, V> extends java.util.AbstractMap<K, V> {
        ...
        _containsValue(value : any, entries : java.lang.Iterable<Map.Entry<K, V>>) : boolean {
            for(var index187=entries.iterator();index187.hasNext();) {
                var entry = index187.next();
                {
...
namespace java.util {
    ...
    export class IdentityHashMap<K, V> extends java.util.AbstractHashMap<K, V> implements java.util.Map<K, V>, java.lang.Cloneable, java.io.Serializable {
        ...
        public equals(obj : any) : boolean {
            ...
            for(var index188=otherMap.entrySet().iterator();index188.hasNext();) {
        ...
        public hashCode() : number {
            var hashCode : number = 0;
            for(var index189=this.entrySet().iterator();index189.hasNext();) {
...
namespace java.util {
    ...
    export class EnumMap<K extends java.lang.Enum<K>, V> extends java.util.AbstractMap<K, V> {
        ...
        public containsValue(value : any) : boolean {
            for(var index190=this.__keySet.iterator();index190.hasNext();) {
                var key = index190.next();
                {
...
namespace javaemul.internal {
    ...
    export class StringHelper {
        public static CASE_INSENSITIVE_ORDER : java.util.Comparator<string>; public static CASE_INSENSITIVE_ORDER_$LI$() : java.util.Comparator<string> { if(StringHelper.CASE_INSENSITIVE_ORDER == null) StringHelper.CASE_INSENSITIVE_ORDER = new StringHelper.StringHelper$0(); return StringHelper.CASE_INSENSITIVE_ORDER; };

        public static copyValueOf$char_A(v : string[]) : string {
            return StringHelper.valueOf(v);
        }

        public static copyValueOf(v? : any, offset? : any, count? : any) : any {
            if(((v != null && v instanceof Array) || v === null) && ((typeof offset === 'number') || offset === null) && ((typeof count === 'number') || count === null)) {
                ...
                return <any>javaemul.internal.StringHelper.copyValueOf$char_A(v);
            } else throw new Error('invalid overload');
        }

        public static valueOf$boolean(x : boolean) : string {
            return "" + x;
        }

        public static valueOf$char(x : string) : string {
            return "" + x;
        }

        public static valueOf(x? : any, offset? : any, count? : any) : any {
            if(((x != null && x instanceof Array) || x === null) && ((typeof offset === 'number') || offset === null) && ((typeof count === 'number') || count === null)) {
                return <any>(() => {
                    var end : number = offset + count;
                    javaemul.internal.InternalPreconditions.checkStringBounds(offset, end, x.length);
                    var batchSize : number = javaemul.internal.ArrayHelper.ARRAY_PROCESS_BATCH_SIZE;
                    var s : string = "";
                    for(var batchStart : number = offset; batchStart < end; ) {
                        var batchEnd : number = Math.min(batchStart + batchSize, end);
                ...
                return <any>javaemul.internal.StringHelper.valueOf$char_A(x);
            } else if(((typeof x === 'boolean') || x === null) && offset === undefined && count === undefined) {
                return <any>javaemul.internal.StringHelper.valueOf$boolean(x);
            } else if(((typeof x === 'string') || x === null) && offset === undefined && count === undefined) {
                return <any>javaemul.internal.StringHelper.valueOf$char(x);
            } else if(((typeof x === 'number') || x === null) && offset === undefined && count === undefined) {
                return <any>javaemul.internal.StringHelper.valueOf$int(x);
            } else if(((typeof x === 'number') || x === null) && offset === undefined && count === undefined) {
                return <any>javaemul.internal.StringHelper.valueOf$long(x);
            } else if(((typeof x === 'number') || x === null) && offset === undefined && count === undefined) {
                return <any>javaemul.internal.StringHelper.valueOf$float(x);
            } else if(((typeof x === 'number') || x === null) && offset === undefined && count === undefined) {
                return <any>javaemul.internal.StringHelper.valueOf$double(x);
            } else if(((x != null) || x === null) && offset === undefined && count === undefined) {
                return <any>javaemul.internal.StringHelper.valueOf$java_lang_Object(x);
            } else throw new Error('invalid overload');
        }

        private static fromCharCode(array : any[]) : string {
            return String.fromCharCode(<number><any>array);
        }

        public static valueOf$char_A(x : string[]) : string {
            return StringHelper.valueOf(x, 0, x.length);
        }

        public static valueOf$double(x : number) : string {
            return "" + x;
        }

        public static valueOf$float(x : number) : string {
            return "" + x;
        }

        public static valueOf$int(x : number) : string {
            return "" + x;
        }

        public static valueOf$long(x : number) : string {
            return "" + x;
        }

        public static valueOf$java_lang_Object(x : any) : string {
         ...
         * @skip
         */
        private static translateReplaceString(replaceStr : string) : string {
            var pos : number = 0;
        ...
        private static compareTo(thisStr : string, otherStr : string) : number {
            if (thisStr == otherStr) {
            return 0;
            }
        ...
        private static getCharset(charsetName : string) : java.nio.charset.Charset {
            try {
        ...
        static fromCodePoint(codePoint : number) : string {
            if(codePoint >= javaemul.internal.CharacterHelper.MIN_SUPPLEMENTARY_CODE_POINT) {
                var hiSurrogate : string = javaemul.internal.CharacterHelper.getHighSurrogate(codePoint);
                var loSurrogate : string = javaemul.internal.CharacterHelper.getLowSurrogate(codePoint);
                return /* valueOf */new String(hiSurrogate).toString() + /* valueOf */new String(loSurrogate).toString();
            } else {
                return /* valueOf */new String(String.fromCharCode(codePoint)).toString();
            }
        }

        public static format(formatString : string, ...args : any[]) : string {
    ...
    export namespace StringHelper {
        ...
        export class StringHelper$0 implements java.util.Comparator<string> {
...
namespace java.io {
    ...
    export class FileInputStream extends java.io.InputStream {
            ...
            if(((typeof name === 'string') || name === null)) {
                {
                    ...
                    this.index = 0;
                    (() => {
                        var name : string = (file != null?file.getPath():null);
                        if(name == null) {
                            throw new java.lang.NullPointerException();
                        }
                        if(file.isInvalid()) {
                        ...
                        this.content = (<any>atob(java.io.File.fs_$LI$().getEntry(file.getAbsolutePath()).data));
                        this.index = 0;
                    })();
                }
                (() => {
        ...
        private readBytes(b : number[], off : number, len : number) : number {
            if(this.index >= this.content.length) {
                return -1;
            }
            var count : number = 0;
