            ...
            var Logger = (function () {
                ...
                Logger.prototype.actuallyLog$java_util_logging_LogRecord = function (record) {
                    if (this.isLoggable(record.getLevel())) {
                        {
                            var array126 = this.getHandlers();
                            for (var index125 = 0; index125 < array126.length; index125++) {
                                var handler = array126[index125];
                                {
                        ...
                        while ((logger != null)) {
                            {
                                var array128 = logger.getHandlers();
                                for (var index127 = 0; index127 < array128.length; index127++) {
                                    var handler = array128[index127];
                                    {
                                        handler.publish(record);
                                    }
                                }
    ...
    (function (util) {
        ...
        var AbstractMap = (function () {
            ...
            AbstractMap.prototype.equals = function (obj) {
                ...
                for (var index143 = otherMap.entrySet().iterator(); index143.hasNext();) {
                    var entry = index143.next();
                    {
            ...
            AbstractMap.prototype.putAll = function (map) {
                ...
                for (var index144 = map.entrySet().iterator(); index144.hasNext();) {
                    var e = index144.next();
                    {
            ...
            AbstractMap.prototype.toString$ = function () {
                var joiner = new java.util.StringJoiner(", ", "{", "}");
                for (var index145 = this.entrySet().iterator(); index145.hasNext();) {
    ...
    (function (util) {
        ...
        var Collections = (function () {
            ...
            Collections.copy = function (dest, src) {
                ...
                for (var index147 = src.iterator(); index147.hasNext();) {
                    var e = index147.next();
                    {
                        destIt.next();
                        destIt.set(e);
            ...
            Collections.disjoint = function (c1, c2) {
                ...
                for (var index148 = iterating.iterator(); index148.hasNext();) {
                    var o = index148.next();
                    {
            ...
            Collections.frequency = function (c, o) {
                var count = 0;
                for (var index149 = c.iterator(); index149.hasNext();) {
                    var e = index149.next();
                    {
                        if (java.util.Objects.equals(o, e)) {
                            ++count;
            ...
            Collections.shuffle = function (list, rnd) {
                ...
                if (list != null && list["__interfaces"] != null && list["__interfaces"].indexOf("java.util.RandomAccess") >= 0) {
                    ...
                    for (var index150 = 0; index150 < arr.length; index150++) {
                        var e = arr[index150];
                        {
                            it.next();
                            it.set(e);
            ...
            Collections.hashCode$java_lang_Iterable = function (collection) {
                var hashCode = 0;
                for (var index151 = collection.iterator(); index151.hasNext();) {
                    var e = index151.next();
                    {
            ...
            Collections.hashCode = function (list) {
                if (((list != null && list["__interfaces"] != null && list["__interfaces"].indexOf("java.util.List") >= 0) || list === null)) {
                    return (function () {
                        var hashCode = 1;
                        for (var index152 = list.iterator(); index152.hasNext();) {
                            var e = index152.next();
                            {
        ...
        (function (Collections) {
            ...
            var UnmodifiableList = (function (_super) {
                ...
                UnmodifiableList.prototype.indexOf = function (o) {
                    return this.list.indexOf(o);
                };
                UnmodifiableList.prototype.isEmpty = function () {
                    return this.list.isEmpty();
                };
                UnmodifiableList.prototype.lastIndexOf = function (o) {
    ...
    (function (util) {
        ...
        var EnumMap = (function (_super) {
            ...
            EnumMap.prototype.containsValue = function (value) {
                for (var index157 = this.__keySet.iterator(); index157.hasNext();) {
                    var key = index157.next();
                    {
    ...
    (function (util) {
        ...
        var AbstractHashMap = (function (_super) {
            ...
            AbstractHashMap.prototype._containsValue = function (value, entries) {
                for (var index177 = entries.iterator(); index177.hasNext();) {
                    var entry = index177.next();
                    {
    ...
    (function (util) {
        ...
        var IdentityHashMap = (function (_super) {
            ...
            IdentityHashMap.prototype.equals = function (obj) {
                ...
                for (var index178 = otherMap.entrySet().iterator(); index178.hasNext();) {
                    var entry = index178.next();
                    {
            ...
            IdentityHashMap.prototype.hashCode = function () {
                var hashCode = 0;
                for (var index179 = this.entrySet().iterator(); index179.hasNext();) {
                    var entry = index179.next();
                    {
    ...
    (function (util) {
        ...
        (function (AbstractNavigableMap) {
            var DescendingMap = (function (_super) {
                ...
                DescendingMap.prototype.put$java_lang_Object$java_lang_Object = function (key, value) {
            ...
            AbstractSequentialList.prototype.addAll = function (index, c) {
                ...
                if (((typeof index === 'number') || index === null) && ((c != null && c["__interfaces"] != null && c["__interfaces"].indexOf("java.util.Collection") >= 0) || c === null)) {
                    return (function () {
                        ...
                        var modified = false;
                        var iter = _this.listIterator(index);
                        for (var index183 = c.iterator(); index183.hasNext();) {
                            var e = index183.next();
                            {
                                iter.add(e);
                                modified = true;
