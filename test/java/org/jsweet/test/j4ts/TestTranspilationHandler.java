...
public class TestTranspilationHandler extends ConsoleTranspilationHandler {
	...
	public final List<JSweetProblem> reportedProblems = new ArrayList<>();
	public final List<SourcePosition> reportedSourcePositions = new ArrayList<>();
